...
class CreateOffersTab extends StatefulWidget {
  const CreateOffersTab({super.key});

  @override
  State<CreateOffersTab> createState() => _CreateOffersTabState();
}

class _CreateOffersTabState extends State<CreateOffersTab> {
  // Text Editing Controllers
  late final Rx<TextEditingController> offerTitleTextController =
      Get.put(TextEditingController().obs, tag: "offerTitleTextController");
  ...
  late final Rx<TextEditingController> offerDescriptionTextController = Get.put(
      TextEditingController().obs,
      tag: "offerDescriptionTextController");
  ...
  late DateTimeRange offerPeriodRange;
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: MyTextFieldWithOutBorder(
            ...
            textController: offerTitleTextController.value,
        ...
        Padding(
          padding: EdgeInsets.symmetric(
              ...
              .copyWith(bottom: Dimensions.h15),
          child: CustomTextFieldWithHead(
            hintText: AppString.offerDescription,
            textInputType: TextInputType.multiline,
            controller: offerDescriptionTextController.value,
            prefixIcon: ImageAsset.icAboutYourself,
            maxLine: 4,
            padding: EdgeInsets.only(top: Dimensions.h10),
            iconBottomPadding: Dimensions.h53,
              ...
              onTap: () {
                showDateRangePicker(
                  ...
                  initialDateRange: selectedStartDateAndEndDate.isEmpty
                      ? null
                      : DateTimeRange(
                          start: offerPeriodRange.start,
                          end: offerPeriodRange.end),
                  firstDate: DateTime(DateTime.now().year, 1, 1),
                  lastDate: DateTime(2030),
                  initialEntryMode: DatePickerEntryMode.input,
                ).then((DateTimeRange? value) {
                  if (value != null) {
                    offerPeriodRange = value;
